...
The data were obtained from ESPN’s site hittrackeronline.com (URL: http://www.hittrackeronline.com/top_true_distance.php). This site is run by ESPN Stats and Information Group. The original data consisted of a list of each home run hit in the 2017 season, which player hit the home run, the player's team, and the true distance (defined as the estimated total distance the ball would have traveled in the absence of physical barriers) of the hit in feet.
